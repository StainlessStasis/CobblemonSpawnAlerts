...
*enabled*: Enables the spawn message for the Pokemon. This will override every other config setting for the Pokemon and make its spawn message never display.<br>
